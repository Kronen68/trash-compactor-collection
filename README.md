# Trash Compactor Collection Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/trash-compactor-collection/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest TCC into src-en/ directory
